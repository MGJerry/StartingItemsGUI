    ...
    namespace StartingItemsGUI {
        public class Data : MonoBehaviour {
            ...
            static void SaveConfig() {
                ...
                configString += "\n\n# The multiplier for how many EarntConsumable credits to award on Eclipse\n#\n# Setting type: Float\n# Default value: " + DataEarntConsumable.eclipseMultiplierDefault.ToString() + "\n" + DataEarntConsumable.eclipseMultiplierName[0] + variableCharUpdate + DataEarntConsumable.eclipseMultiplier.ToString();
